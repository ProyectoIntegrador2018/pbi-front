            ...
            <v-container>
              <v-row justify="center" class="py-0">
                <v-col cols="12" sm="2" class="py-0">
                  ...
                  <v-text-field v-model.number="comidas[0].fruit" single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Verduras:
                  </span>
                  <v-text-field v-model.number="comidas[0].vegetable"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leguminosas:
                  </span>
                  <v-text-field v-model.number="comidas[0].legume"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Cereal:
                  </span>
                  <v-text-field v-model.number="comidas[0].cereal"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Azúcar:
                  </span>
                  <v-text-field v-model.number="comidas[0].sugar"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Grasa:
                  </span>
                  <v-text-field v-model.number="comidas[0].fat"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
              </v-row>
              ...
              <v-row justify="center" class="py-0">
                <v-col cols="12" sm="2" class="py-0">
                  ...
                  <v-text-field v-model.number="comidas[0].milkWhole"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leche Semidescremada:
                  </span>
                  <v-text-field v-model.number="comidas[0].milkSemiSkimmed"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leche Descremada:
                  </span>
                  <v-text-field v-model.number="comidas[0].milkSkimmed"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Entera:
                  </span>
                  <v-text-field v-model.number="comidas[0].meatWhole"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Semigrasosa:
                  </span>
                  <v-text-field v-model.number="comidas[0].meatSemiGreasy"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Grasosa:
                  </span>
                  <v-text-field v-model.number="comidas[0].meatGreasy"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
              </v-row>
            </v-container>
          </v-card-text>
            ...
            <v-container>
              <v-row justify="center" class="py-0">
                <v-col cols="12" sm="2" class="py-0">
                  ...
                  <v-text-field v-model.number="comidas[1].fruit"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Verduras:
                  </span>
                  <v-text-field v-model.number="comidas[1].vegetable"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leguminosas:
                  </span>
                  <v-text-field v-model.number="comidas[1].legume"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Cereal:
                  </span>
                  <v-text-field v-model.number="comidas[1].cereal"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Azúcar:
                  </span>
                  <v-text-field v-model.number="comidas[1].sugar"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Grasa:
                  </span>
                  <v-text-field v-model.number="comidas[1].fat"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
              </v-row>
              ...
              <v-row justify="center" class="py-0">
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">Leche Entera</span>
                  <v-text-field v-model.number="comidas[1].milkWhole"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leche Semidescremada:
                  </span>
                  <v-text-field v-model.number="comidas[1].milkSemiSkimmed"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leche Descremada:
                  </span>
                  <v-text-field v-model.number="comidas[1].milkSkimmed"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Entera:
                  </span>
                  <v-text-field v-model.number="comidas[1].meatWhole"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Semigrasosa:
                  </span>
                  <v-text-field v-model.number="comidas[1].meatSemiGreasy"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Grasosa:
                  </span>
                  <v-text-field v-model.number="comidas[1].meatGreasy"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
              </v-row>
            </v-container>
          </v-card-text>
            ...
            <v-container>
              <v-row justify="center" class="py-0">
                <v-col cols="12" sm="2" class="py-0">
                  ...
                  <v-text-field v-model.number="comidas[2].fruit"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Verduras:
                  </span>
                  <v-text-field v-model.number="comidas[2].vegetable"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leguminosas:
                  </span>
                  <v-text-field v-model.number="comidas[2].legume"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Cereal:
                  </span>
                  <v-text-field v-model.number="comidas[2].cereal"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Azúcar:
                  </span>
                  <v-text-field v-model.number="comidas[2].sugar"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Grasa:
                  </span>
                  <v-text-field v-model.number="comidas[2].fat"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
              </v-row>
              ...
              <v-row justify="center" class="py-0">
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">Leche Entera</span>
                  <v-text-field v-model.number="comidas[2].milkWhole"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leche Semidescremada:
                  </span>
                  <v-text-field v-model.number="comidas[2].milkSemiSkimmed"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Leche Descremada:
                  </span>
                  <v-text-field v-model.number="comidas[2].milkSkimmed"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Entera:
                  </span>
                  <v-text-field v-model.number="comidas[2].meatWhole"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Semigrasosa:
                  </span>
                  <v-text-field v-model.number="comidas[2].meatSemiGreasy"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2" class="py-0">
                  <span class="subtitle-2">
                    Carne Grasosa:
                  </span>
                  <v-text-field v-model.number="comidas[2].meatGreasy"  single-line :rules="numberRules" solo @focus="$event.target.select()"></v-text-field>
                </v-col>
              </v-row>
            </v-container>
          </v-card-text>
