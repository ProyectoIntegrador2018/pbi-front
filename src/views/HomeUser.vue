<template>
  <div>
    ...
    <!--Código para la progress bar -->
    <v-row v-row align="center" justify="center">
      <v-col class="px-0 mx-0 my-0" cols="9">
        <h3>Mi progreso de inscripción:</h3>
      </v-col>
    ...
    getUserInfo() {
      ...
      axios
        ...
        .then(response => {
          ...
          if(this.userData){
            this.progreso+=0.166666
            if(this.medRecord){
              this.progreso+=0.33333
